...
class MixpostEnterprise
{
    public static function assets()
    {
        ...
        return new HtmlString(<<<HTML
                <script type="module" src="/vendor/mixpost-enterprise/{$manifest['resources/js/mixpost-enterprise/app.js']['file']}"></script>
                <link rel="stylesheet" href="/vendor/mixpost-enterprise/{$manifest['resources/js/mixpost-enterprise/app.js']['css'][0]}">
            HTML
        );
    }
}
