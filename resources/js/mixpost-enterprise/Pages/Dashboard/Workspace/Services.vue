...
const TwitterServiceForm = defineAsyncComponent(() => import("@e/Components/ServiceForm/TwitterServiceForm.vue"));
...
<template>
    ...
    <PageHeader :title="$t('service.third_party_services')" :with-padding-x="false">
