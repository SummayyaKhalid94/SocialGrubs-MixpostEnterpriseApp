...
import useEnabledFeatures from "@p/Composables/useEnabledFeatures";
import Dropdown from "@p/Components/Dropdown/Dropdown.vue";
import DropdownItem from "@p/Components/Dropdown/DropdownItem.vue";
import Avatar from "@p/Components/DataDisplay/Avatar.vue";
import PencilSquareIcon from "@p/Icons/PencilSquare.vue";
import CogIcon from "@p/Icons/Cog.vue";
import ArrowRightOnRectangleIcon from "@p/Icons/ArrowRightOnRectangle.vue";
import MenuDelimiter from "@p/Components/Sidebar/MenuDelimiter.vue";
import Briefcase from "@p/Icons/Briefcase.vue";
import Plus from "@p/Icons/Plus.vue";
import CreditCard from "@p/Icons/CreditCard.vue";
import Badge from "../DataDisplay/Badge.vue";
import KeyIcon from "@p/Icons/Key.vue";
