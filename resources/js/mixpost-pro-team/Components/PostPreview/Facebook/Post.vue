...
import Gallery from "@p/Components/ProviderGallery/Facebook/FacebookGallery.vue"
import EditorReadOnly from "@p/Components/Package/EditorReadOnly.vue";

import fbIconsImgUrl from "@pimg/fb-icons.png"
    ...
    <div class="mt-5 flex items-center justify-between">
        <div v-tooltip="$t('service.representative_data')" class="flex items-center">
            <div class="flex mr-xs">
                <img src="@pimg/fb-like.svg" class="w-5 h-5 z-10" alt=""/>
                <img src="@pimg/fb-wow.svg" class="w-5 h-5 -ml-1" alt=""/>
            </div>
